...
**If any files exist**, use question tool:
...
After they respond, use question tool:
...
**If the tech-stack standard exists**, read it and use question tool:
...
**If no tech-stack standard exists** (or they chose option 2 above), use question tool:
