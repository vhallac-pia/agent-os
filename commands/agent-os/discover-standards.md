...
3. Use question tool to present the areas:
...
3. Use question tool to present findings and let user select:
...
1. **Ask 1-2 clarifying questions** about the "why" behind the pattern. Use your question tool for this.
...
3. Draft the content and use question tool to confirm:
...
2. For each new file without an index entry, use question tool:
